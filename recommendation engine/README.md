...
This project features a content-based recommendation system that maps user preferences against a movie corpus using Natural Language Processing (NLP) and vector space modeling.
