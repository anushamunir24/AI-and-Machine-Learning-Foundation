...
This project is part of the DecodeLabs AI Industrial Training. It demonstrates a complete Machine Learning workflow to classify Iris flower species based on their sepal and petal measurements using the K-Nearest Neighbors (KNN) algorithm.
...
1. Navigate to this `project2` folder.
